                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sex" type="radio" class="form-control @error('sex') is-invalid @enderror" name="sex" value="Male" required>Male
                                <input id="sex" type="radio" class="form-control @error('sex') is-invalid @enderror" name="sex" value="Female" required>Female
